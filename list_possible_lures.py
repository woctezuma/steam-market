...
from sack_of_gems import load_sack_of_gems_price, get_num_gems_per_sack_of_gems
...
def get_sell_prices_without_fee(app_ids,
    ...
    for listing_hash in data:
        ...
        if app_id in app_ids:
            ...
            sell_price_in_euros_without_fee = compute_sell_price_without_fee(sell_price_after_arbitrary_offset)
